package com.flow.eda.server.flow.status;

import com.flow.eda.common.utils.CollectionUtil;
import com.flow.eda.server.flow.Flow;
import com.flow.eda.server.flow.FlowMapper;
import com.flow.eda.server.flow.FlowRequest;
...
@Service
public class FlowStatusUpdateService {
    ...
    public void stopRunningFlow() {
        ...
        CollectionUtil.forEach(flowList, flow -> flowDataRuntime.stopFlowData(flow.getId()));
    }
}
