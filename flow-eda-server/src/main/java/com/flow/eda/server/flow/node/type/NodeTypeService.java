package com.flow.eda.server.flow.node.type;

import com.flow.eda.server.flow.node.type.param.NodeTypeParam;
import com.flow.eda.server.flow.node.type.param.NodeTypeParamMapper;
...
public class NodeTypeService {
    ...
    private static final List<String> TYPE_MENU =
            Arrays.asList("基础", "运算", "算法", "解析", "网络", "数据库", "子流程");
