package com.flow.eda.server.status;

import com.flow.eda.common.model.FlowData;
import com.flow.eda.server.runtime.node.Node;
import com.flow.eda.server.flow.FlowService;
import com.flow.eda.server.flow.node.data.NodeDataService;
...
public class FlowStatusService {
    ...
    public void stopInstance(String instanceId) {
        ...
        // 关闭并移除线程池
        com.flow.eda.server.runtime.FlowThreadPool.removeThreadPool(instanceId);
    }
}
